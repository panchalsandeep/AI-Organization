...
* `backend/` — FastAPI core application containing auth, multi-tenancy context, audit logging, and security utilities.
* `applications/ai-dashboard/` — Next.js 14 frontend admin and tenant console.
* `supabase/migrations/` — Database migrations for initializing tables and governance policies.

---

## 🚀 Professional Pitch (LinkedIn Copy-Paste)

### **Title**: Lead / Core Engineer – Enterprise AI Operations & Governance Platform
